...
import { Lock, Mail, ArrowRight, Loader2, ShieldCheck, X, FileText } from 'lucide-react';
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-4xl w-full shadow-2xl border border-slate-100 relative max-h-[85vh] flex flex-col overflow-hidden">
            ...
            <div className="pt-4 flex items-center justify-end space-x-3">
              <button
                type="button"
                onClick={() => setShowTermsModal(false)}
                className="w-full sm:w-auto text-slate-500 hover:bg-slate-100 font-bold py-3 px-6 rounded-2xl transition-all text-sm flex items-center justify-center space-x-2"
              >
                <span>Vazgeç</span>
              </button>
              <button
